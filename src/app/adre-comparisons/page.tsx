...
export const metadata = buildMetadata({
  title: 'ADRE Exam Comparisons — Grade 3 vs 4, Syllabus, Assam Police, APSC & SSC Differences',
  description: 'In-depth comparison guides for ADRE Grade 3 vs Grade 4, syllabus differences, salary scales, age limits, and how ADRE compares against Assam Police, APSC, and SSC exams.',
  path: '/adre-comparisons/',
});

export default function AdreComparisonsHubPage() {
      ...
      <div className="glass-panel p-6 sm:p-10 rounded-3xl space-y-6 border-[#E5DAC8]">
        <div className="space-y-2 border-b border-[#E5DAC8] pb-6">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold text-[#1D1814] mt-2">
            ADRE Exam Comparisons & Analysis
          </h1>
          <p className="text-[#6B5D52] text-sm sm:text-base max-w-3xl leading-relaxed font-medium">
            Understand key differences between Grade 3 vs Grade 4, exam patterns, eligibility rules, and how ADRE compares to APSC, Assam Police, and SSC examinations.
          </p>
        </div>
      </div>
        ...
        {articles.map((art) => (
          ...
          >
            <div className="space-y-3">
              <span className="inline-block px-2.5 py-1 text-[10px] font-mono font-bold uppercase bg-[#C9A468]/20 text-[#7D5618] rounded-md">
                Comparison Guide
              </span>
